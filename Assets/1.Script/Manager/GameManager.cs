...
public class GameManager : MonoBehaviour
{
    ...
    private bool isInventoryPanelOpen = false; //인벤토리 활성화 여부
    private bool isSoundPanelOpen = false; //사운드세팅 활성화 여부
    ...
    void Update()
    {
        ...
        {
            if (isSettingPanelOpen || isSoundPanelOpen)
            {
                CloseSettingPanel();
                ClosesoundPanel();
            }
    ...
    public void CloseSettingPanel() //설정창 닫기
    {
        if (isPaused)
        {
            ResumeGame();
    ...
    public void OpensoundPanel() //사운드세팅 열기
    {
        soundPanel.SetActive(true);
        isSoundPanelOpen = true;
    }

    public void ClosesoundPanel() //사운드세팅 닫기
    {
